/* airportfyi-embed v1.0.0 | MIT | https://widget.airportfyi.com */
...
(function bootstrap() {
  const config = '{"site":"airportfyi","name":"AirportFYI","domain":"airportfyi.com","accent":"#D97706","attribute":"data-airportfyi","apiBase":"https://airportfyi.com/api/v1/","searchPath":"/search/","entityName":"Airports","entitySlug":"airports"}';
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"airportfyi","name":"AirportFYI","domain":"airportfyi.com","accent":"#D97706","attribute":"data-airportfyi","apiBase":"https://airportfyi.com/api/v1/","searchPath":"/search/","entityName":"Airports","entitySlug":"airports"}');
    }
    ...
    _syncDataAttrs() {
      const attrKey = '{"site":"airportfyi","name":"AirportFYI","domain":"airportfyi.com","accent":"#D97706","attribute":"data-airportfyi","apiBase":"https://airportfyi.com/api/v1/","searchPath":"/search/","entityName":"Airports","entitySlug":"airports"}'.attribute.replace("data-", "");
...
(function registerElements() {
  ...
  const site = '{"site":"airportfyi","name":"AirportFYI","domain":"airportfyi.com","accent":"#D97706","attribute":"data-airportfyi","apiBase":"https://airportfyi.com/api/v1/","searchPath":"/search/","entityName":"Airports","entitySlug":"airports"}'.site;
  const defs = [
